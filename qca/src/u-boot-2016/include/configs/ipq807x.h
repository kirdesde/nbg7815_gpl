...
#define CONFIG_PREBOOT	"dcache off"
#define CONFIG_ETHADDR	00:A0:C5:CC:DD:00
...
#define CONFIG_ZYXEL_RESET_BTN

#define CONFIG_ZYXEL_ZLOADER_ADDR	"530000"
#define CONFIG_ZYXEL_ZLOADER1_ADDR	"5F0000"
#define CONFIG_ZYXEL_ZLOADER_BOOTCMD	"sf probe && sf read 44000000 ${zld_addr} 10000 && bootm 44000000"

#undef CONFIG_IPQ_ETH_INIT_DEFER
#define CONFIG_ZYXEL_EXEC_ZLOADER
