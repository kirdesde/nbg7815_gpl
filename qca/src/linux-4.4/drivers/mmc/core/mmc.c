...
static void mmc_select_card_type(struct mmc_card *card)
{
	...
	/* modified by DNI - EMMC frequency is fixed on 52Mhz for EVT board, we will check again for next DVT board, comment here is for debug purpose */
#if 0
	...
	/* modified by DNI - EMMC frequency is fixed on 52Mhz for EVT board, we will check again for next DVT board */
	hs_max_dtr = MMC_HIGH_52_MAX_DTR;
	avail_type |= EXT_CSD_CARD_TYPE_HS_52;
