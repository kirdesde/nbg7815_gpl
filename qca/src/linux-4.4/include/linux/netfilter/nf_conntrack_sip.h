...
enum sip_method {
	METHOD_NONE,
	METHOD_INVITE_REQUEST,
	METHOD_INVITE_RESPONSE,
	METHOD_UPDATE_RESPONSE,
	METHOD_PRACK_RESPONSE,
	METHOD_BYE,
	METHOD_CANCEL,
	METHOD_MAX
};
...
#define CALLID_STR_LEN	256
#define AGENT_INFO_TMEOUT_SEC	180
struct agent_info {
	union nf_inet_addr src;
	__be16 port;
	char callid[CALLID_STR_LEN];
	/* Timer function; deletes the agent_info. */
