...
ppp_generic_init_config() {
	...
	proto_config_add_string dns3
	proto_config_add_string dnsv6_1
	proto_config_add_string dnsv6_2
	proto_config_add_string dnsv6_3
...
ppp_generic_setup() {
	...
	[ -n "$pppname" ] || pppname="${proto:-ppp}-wan"
	[ -n "$unnumbered" ] && {
		local subnets
...
proto_pppoe_init_config() {
	...
	proto_config_add_string "pppoeWanIpAddr"
	lasterror=1
}
...
proto_pppoe_setup() {
	...
	json_get_var pppoeWanIpAddr pppoeWanIpAddr
...
proto_pptp_init_config() {
	...
	proto_config_add_string "wan_fixed_ip"
	available=1
	no_device=1
	lasterror=1
}
