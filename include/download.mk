...
define Download
  ...
  $(DL_DIR)/$(FILE):
	mkdir -p $(DL_DIR)
	$(if $(findstring git_src,$(PROTO)),$(if $(DownloadMethod/$(call dl_method,$(URL),$(PROTO))),$(DownloadMethod/$(call dl_method,$(URL),$(PROTO))),$(DownloadMethod/unknown)),
	$(if $(CONFIG_ZYXEL_FORCE_DOWNLOAD_DEFAULT),$(DownloadMethod/default),
